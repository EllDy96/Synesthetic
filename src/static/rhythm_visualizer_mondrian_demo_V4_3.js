...
function preload()
{
  ...
  //upload drum sounds
  kick = new Tone.Player("assets/Synesthetic_drums/kick_DM.wav").toDestination();
  snare = new Tone.Player('assets/Synesthetic_drums/snare.wav').toDestination();
  hihat = new Tone.Player('assets/Synesthetic_drums/hihat.wav').toDestination();
  oh = new Tone.Player('assets/Synesthetic_drums/oh.wav').toDestination();
}
